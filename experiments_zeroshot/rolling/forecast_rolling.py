...
def plot_forecast(combined_data, test_start_idx, forecasts, actual_values, test_dates, metrics, target_name):
    ...
    # Save plot
    output_path = 'experiments_zeroshot/rolling/forecast_rolling_plot.png'
...
def plot_metrics(forecasts, actual_values, test_dates, metrics):
    ...
    # Save plot
    output_path = 'experiments_zeroshot/rolling/forecast_rolling_metrics_plot.png'
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
...
def main():
    ...
    output_file = 'experiments_zeroshot/rolling/forecast_rolling_output.txt'
