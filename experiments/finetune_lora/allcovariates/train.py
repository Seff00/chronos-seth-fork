...
Performs rolling 1-day ahead prediction on test set after training.
"""
...
def main():
    ...
    output_file = os.path.join(output_dir, 'training_output.txt')
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        ...
        try:
            ...
            # Prepare data for rolling evaluation
    ...
    if config['output']['save_plots']:
        ...
        finetuned_pipeline = Chronos2Pipeline.from_pretrained(
            os.path.join(checkpoint_dir, "finetuned-ckpt"),
            device_map=config['model']['device_map'],
            torch_dtype=torch_dtype,
        )
